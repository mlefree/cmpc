...
echo ""
echo "[--- C4P : LOCAL Build mobile ---]"
echo ""

#sudo npm update -g cordova
rm -rf build

cordova create build com.apps4pro.c4plocal c4p
...
#cordova plugin add https://github.com/apache/cordova-plugins.git
...
#jarsigner -keystore ../../../../../c4p/c4p_html_ang/mobile_res/android_key/apps4pro-key.keystore -storepass apps4pro -digestalg SHA1 -sigalg MD5withRSA bin/C4P_Local-release-unsigned.apk mykey
#cp bin/C4P_Local-release-unsigned.apk ../../C4P_Local.apk
#zipalign -f 4 ../../C4P_Local.apk ../../C4P_Local-aligned.apk
#cd ../..
